...
class PublicacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publicacion" do
    assert_difference('Publicacion.count') do
      post publicacions_url, params: { publicacion: { autor: @publicacion.autor, ciudad: @publicacion.ciudad, fecha: @publicacion.fecha, puntaje: @publicacion.puntaje, texto: @publicacion.texto, tipo: @publicacion.tipo, titulo: @publicacion.titulo } }
    end
  ...
  test "should update publicacion" do
    patch publicacion_url(@publicacion), params: { publicacion: { autor: @publicacion.autor, ciudad: @publicacion.ciudad, fecha: @publicacion.fecha, puntaje: @publicacion.puntaje, texto: @publicacion.texto, tipo: @publicacion.tipo, titulo: @publicacion.titulo } }
